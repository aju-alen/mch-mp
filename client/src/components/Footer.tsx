...
const Footer = () => {
  ...
  return (
    <footer className="bg-trump-light-primary text-trump-light-navy pt-16 pb-6">
      <div className="container mx-auto px-4">
        ...
        <div className="text-xs text-gray-600 border-t border-gray-200 pt-6 flex flex-col sm:flex-row justify-between items-center text-center sm:text-left px-4 sm:px-8 lg:px-16">
  {/* Left Section */}
  ...
  {/* Footer Nav Bar */}
  <div className="flex flex-col sm:flex-row flex-wrap gap-4 text-gray-600 justify-center sm:justify-end items-center">
